    ...
    <div>
      <div className="flex flex-col md:flex-row items-start justify-between gap-5 md:gap-10 mb-10 md:mb-0">
        <div className="text-left">
          ...
          {/* Subtitle */}
          <h1 data-aos="fade-up"
          data-aos-duration="800" className="text-gray-700 text-2xl leading-2 tracking-tight font-semibold max-w-full mt-3 mb-0 md:mb-5">
            Leadership and Faculty
          </h1>
        </div>
        <p data-aos="fade-up"
          data-aos-duration="800" className="font-normal text-base text-left md:text-right text-gray-600 max-w-lg">
