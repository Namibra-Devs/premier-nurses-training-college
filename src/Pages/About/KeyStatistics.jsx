    ...
    <div>
      <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-4">
        ...
        <div
          ...
          className="relative bg-gray-50 rounded-3xl overflow-hidden p-4"
        >
          <div className="mt-14">
        ...
        <div
          data-aos="fade-up"
          data-aos-duration="800"
          className="relative bg-transparent rounded-3xl overflow-hidden p-4"
        >
          <div className="mt-14">
            <div className="absolute top-0 left-0 p-4  bg-primary rounded-br-3xl text-lg font-bold text-white">
        ...
        >
          <div className="mt-14">
            ...
            <p className="text-white text-sm">
              Join a thriving network of over 3,000 graduates who are making a
              difference in healthcare globally.
            </p>
          </div>
        </div>
      </div>
