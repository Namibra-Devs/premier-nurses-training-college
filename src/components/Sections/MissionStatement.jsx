  ...
  return (
    <div>
      <div className="bg-gray-50">
        <div className="flex flex-col md:flex-row md:items-center justify-center gap-10 px-4 md:px-20 py-24">
          <div className="mission-img max-w-full md:max-w-[30%] relative overflow-hidden group">
            <img src={missionImg} alt="" className="w-full rounded-3xl group-hover:brightness-75 duration-700 ease-linear" />
            <h4 className="absolute bottom-4 text-white font-medium text-lg m-5 
